...
class ResultTest(MyTestCase):
    ...
    def test_to_score_str(self):
        self.assertAlmostEqual(
            self.result.get_result("VMAF_legacy_score"), 40.421899030550769, places=4
        )
        ...
        self.assertAlmostEqual(
            self.result.get_result("VMAF_legacy_score"), 37.573531379639725, places=4
        )
        self.result.set_score_aggregate_method(np.max)
        self.assertAlmostEqual(
            self.result.get_result("VMAF_legacy_score"), 44.815357234059327, places=4
        )
        self.result.set_score_aggregate_method(np.median)
        self.assertAlmostEqual(
            self.result.get_result("VMAF_legacy_score"), 38.876808477953254, places=4
        )
        ...
        self.assertAlmostEqual(
            self.result.get_result("VMAF_legacy_score"), 3.1518765879212993, places=4
        )
        self.result.set_score_aggregate_method(np.var)
        self.assertAlmostEqual(
            self.result.get_result("VMAF_legacy_score"), 9.9343260254864134, places=4
        )
        ...
        self.assertAlmostEqual(
            self.result.get_result("VMAF_legacy_score"), 42.439937731616901, places=4
        )
        self.result.set_score_aggregate_method(ListStats.total_variation)
        self.assertAlmostEqual(
            self.result.get_result("VMAF_legacy_score"), 6.5901873052628375, places=4
        )
...
class ScoreAggregationTest(unittest.TestCase):
    ...
    def test_to_score_str(self):
        ...
        self.assertAlmostEqual(
            self.result["VMAF_two_models_array_score"][0], 35.0661575902223, places=4
        )
        self.assertAlmostEqual(
            self.result["VMAF_two_models_array_score"][1], 35.0661575902223, places=4
        )
