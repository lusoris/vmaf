...
class QualityRunnerTest(MyTestCase):
    ...
    def test_run_vmaf_runner_float_vifks3o2(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.3837840319479306, places=3
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.857804947713165, places=2
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.9233334535128187, places=2
        )
        self.assertAlmostEqual(
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_score"], 81.50635007192874, places=1
    ...
    def test_run_vmaf_runner_float_vifks24o10(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.4054443114816349, places=3
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.9245720373397553, places=2
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.9604211024859047, places=2
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.9750504554016111, places=3
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8953518541666665, places=2
        )
    ...
    def test_run_vmaf_runner_float_vifks360o97(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.4250520955733605, places=3
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.9583187986343104, places=2
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.976499720370497, places=2
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.9824524789568665, places=3
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8953518541666665, places=2
        )
    ...
    def test_run_vmaf_runner_float_vifks1o2(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.33224252285074446, places=3
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.5843307831368371, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.7290873047465741, places=3
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.9384341698106438, places=2
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8953518541666665, places=2
        )
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_score"], 75.26224138570674, places=0
    ...
    def test_run_vmaf_runner_float_vifks2(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.39720947799409806, places=3
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.902590363978247, places=2
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.9488381004744343, places=2
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.9685473062944817, places=3
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8953518541666665, places=2
        )
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_score"], 83.69301110293519, places=1
    ...
    def test_run_vmaf_runner_float_vifks2o3(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.34550238312796616, places=3
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.6617754812987201, places=3
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.7862132379297329, places=3
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.8933108841437846, places=3
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8953518541666665, places=2
        )
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_score"], 73.12401678992882, places=1
