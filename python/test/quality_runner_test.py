...
class QualityRunnerTest(MyTestCase):
    ...
    def test_run_vmaf_runner_v061(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.363420489439, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.766647542135, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.862854666902, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.915971778036, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8953518541666665, places=4
        )
        ...
        self.assertAlmostEqual(
            results[1]["VMAF_feature_motion2_score"], 3.8953518541666665, places=4
        )
    ...
    def test_run_ensemblevmaf_runner_same_models(self):
        ...
        self.assertAlmostEqual(
            results[0]["EnsembleVMAF_model_0_score"], 76.68425574067017, places=4
        )
        self.assertAlmostEqual(
            results[0]["EnsembleVMAF_model_1_score"], 76.68425574067017, places=4
        )
    ...
    def test_run_ensemblevmaf_runner_different_models(self):
        ...
        self.assertAlmostEqual(
            results[0]["EnsembleVMAF_model_1_score"], 81.77005183877434, places=3
        )
    ...
    def test_run_bootstrap_vmaf_runner(self):
        ...
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_bagging_score"], 75.11496350766362, places=4
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_bagging_score"], 99.96504855577571, places=4
        )
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_stddev_score"], 0.6816714405308405, places=4
        )
        self.assertAlmostEqual(
    ...
    def test_run_bootstrap_vmaf_runner_with_transform_score(self):
        ...
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_bagging_score"], 91.50418140067052, places=4
        )
        self.assertAlmostEqual(results[1]["BOOTSTRAP_VMAF_bagging_score"], 100.0, places=4)
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_stddev_score"], 0.4609151507341837, places=4
        )
    ...
    def test_run_bootstrap_vmaf_runner_specific_model(self):
        ...
        self.assertAlmostEqual(results[1]["BOOTSTRAP_VMAF_score"], 99.95804893252175, places=4)
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_bagging_score"], 73.08851325162333, places=4
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_bagging_score"], 99.686116179979152, places=4
        )
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_stddev_score"], 1.2292399440451214, places=4
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_stddev_score"], 1.5917514683608882, places=4
        )
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_ci95_low_score"], 70.79156057918671, places=4
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_ci95_low_score"], 94.784491176494996, places=4
        )
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_ci95_high_score"], 74.84074207742032, places=4
        )
        self.assertAlmostEqual(
    ...
    def test_run_bootstrap_vmaf_runner_residue_bootstrap_model(self):
        ...
        self.assertAlmostEqual(results[1]["BOOTSTRAP_VMAF_score"], 99.95804893252175, places=4)
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_bagging_score"], 73.09131553704874, places=4
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_bagging_score"], 99.79000465995409, places=4
        )
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_stddev_score"], 1.1982762081883995, places=4
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_stddev_score"], 1.3028824838324222, places=3
        )
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_ci95_low_score"], 70.81472328674501, places=4
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_ci95_low_score"], 94.79667446930989, places=4
        )
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_ci95_high_score"], 74.83768715705374, places=4
        )
        self.assertAlmostEqual(
    ...
    def test_run_bootstrap_vmaf_runner_default_model(self):
        ...
        self.assertAlmostEqual(results[1]["BOOTSTRAP_VMAF_score"], 99.95804893252175, places=4)
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_bagging_score"], 74.93633669028638, places=4
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_bagging_score"], 99.93908291255723, places=4
        )
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_stddev_score"], 1.31580415378762, places=4
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_stddev_score"], 0.09930398700617331, places=4
        )
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_ci95_low_score"], 72.95957599695008, places=4
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_ci95_low_score"], 91.11567337246434, places=4
        )
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_ci95_high_score"], 77.36730937306012, places=4
        )
    ...
    def test_run_bootstrap_vmaf_runner_default_model_with_transform_score(self):
        ...
        self.assertAlmostEqual(results[1]["BOOTSTRAP_VMAF_score"], 100.0, places=4)
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_bagging_score"], 91.38626993803041, places=4
        )
        self.assertAlmostEqual(results[1]["BOOTSTRAP_VMAF_bagging_score"], 100.0, places=4)
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_stddev_score"], 0.8796499060403885, places=4
        )
    ...
    def test_run_bootstrap_vmaf_runner_10models(self):
        ...
        self.assertAlmostEqual(results[1]["BOOTSTRAP_VMAF_score"], 99.95804893252175, places=4)
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_bagging_score"], 75.1541667848584, places=4
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_bagging_score"], 99.9640738745435, places=4
        )
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_stddev_score"], 1.415440563303708, places=4
        )
        self.assertAlmostEqual(
    ...
    def test_run_bagging_vmaf_runner(self):
        ...
        self.assertAlmostEqual(
            results[0]["BAGGING_VMAF_bagging_score"], 75.11496350766362, places=4
        )
        self.assertAlmostEqual(
            results[1]["BAGGING_VMAF_bagging_score"], 99.965048555775709, places=4
        )
        self.assertAlmostEqual(
            results[0]["BAGGING_VMAF_stddev_score"], 0.6816714405308405, places=4
        )
        self.assertAlmostEqual(
    ...
    def test_run_bootstrap_vmaf_runner_with_4k_1d5H_model(self):
        ...
        self.assertAlmostEqual(results[1]["BOOTSTRAP_VMAF_score"], 100.0, places=4)
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_bagging_score"], 83.97551251514652, places=4
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_bagging_score"], 99.976138971781452, places=4
        )
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_stddev_score"], 0.9285768709567926, places=4
        )
        self.assertAlmostEqual(
    ...
    def test_run_vmaf_runner_input160x90(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_integer_feature_motion2_score"], 1.3596959375, places=4
        )
        self.assertAlmostEqual(
        ...
        self.assertAlmostEqual(
            results[1]["VMAF_integer_feature_motion2_score"], 1.3596959375, places=4
        )
        self.assertAlmostEqual(results[1]["VMAF_integer_feature_adm2_score"], 1.0, places=4)
    ...
    def test_run_bootstrap_vmaf_runner_default_model_json_model(self):
        ...
        self.assertAlmostEqual(results[1]["BOOTSTRAP_VMAF_score"], 99.95804893252175, places=4)
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_bagging_score"], 74.94883517626657, places=4
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_bagging_score"], 99.93908291255723, places=4
        )
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_stddev_score"], 1.3121299437588092, places=4
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_stddev_score"], 0.09930398700617331, places=4
        )
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_ci95_low_score"], 72.97208643408686, places=4
        )
        self.assertAlmostEqual(
            results[1]["BOOTSTRAP_VMAF_ci95_low_score"], 91.1152017392609, places=4
        )
        self.assertAlmostEqual(
            results[0]["BOOTSTRAP_VMAF_ci95_high_score"], 77.36908154045717, places=4
        )
        self.assertAlmostEqual(results[1]["BOOTSTRAP_VMAF_ci95_high_score"], 100.0, places=4)
    ...
    def test_run_vmaf_runner_float_neg_mode(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.9837379749630343, places=4
        )
        with self.assertRaises(KeyError):
    ...
    def test_run_vmaf_runner_float_vifks3o2(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.3837840319479306, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.857804947713165, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.9233334535128187, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.9531892263362162, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8953518541666665, places=4
        )
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_score"], 81.50635007192874, places=4
        )  # pyvmaf: 81.46718219339385
        self.assertAlmostEqual(results[1]["VMAF_score"], 99.946416604585025, places=4)
    ...
    def test_run_vmaf_runner_float_vifks24o10(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.4054443114816349, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.9245720373397553, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.9604211024859047, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.9750504554016111, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8953518541666665, places=4
        )
    ...
    def test_run_vmaf_runner_float_vifks360o97(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.4250520955733605, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.9583187986343104, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.976499720370497, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.9824524789568665, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8953518541666665, places=4
        )
    ...
    def test_run_vmaf_runner_float_vifks1o2(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.33224252285074446, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.5843307831368371, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.7290873047465741, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.9384341698106438, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8953518541666665, places=4
        )
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_score"], 75.26224138570674, places=2
        )  # pyvmaf: 75.14868810608671
        self.assertAlmostEqual(results[1]["VMAF_score"], 99.946416604585025, places=4)
    ...
    def test_run_vmaf_runner_float_vifks2(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.39720947799409806, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.902590363978247, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.9488381004744343, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.9685473062944817, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8953518541666665, places=4
        )
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_score"], 83.69301110293519, places=2
        )  # pyvmaf: 83.699460342183
        self.assertAlmostEqual(results[1]["VMAF_score"], 99.946416604585025, places=4)
    ...
    def test_run_vmaf_runner_float_vifks2o3(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale0_score"], 0.34550238312796616, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.6617754812987201, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.7862132379297329, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.8933108841437846, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_motion2_score"], 3.8953518541666665, places=4
        )
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_score"], 73.12401678992882, places=2
