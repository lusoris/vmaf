...
class FeatureExtractorTest(MyTestCase):
    ...
    def test_executor_id_long_opt_dict(self):
        ...
        self.assertEqual(
            "VMAF_feature_V0.2.7_ab1db6ba9be857303e99cbb0ef38fc4753ef1040", fextractor.executor_id
        )
    ...
    def test_get_log_file_path(self):
        ...
        self.assertTrue(
            re.match(
                r"^my_workdir_root/[a-zA-Z0-9-]+/VMAF_feature_V0.2.7_{}$".format(h), log_file_path
            )
        )
    ...
    def test_run_vmaf_fextractor_with_vif_sigma_nsq(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale1_score"], 0.7433470833333334, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale2_score"], 0.8450055416666666, places=4
        )
        self.assertAlmostEqual(
            results[0]["VMAF_feature_vif_scale3_score"], 0.9031788124999999, places=4
        )
    ...
    def test_run_vmaf_integer_fextractor(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_integer_feature_motion_score"], 4.04982535417, places=2
        )
        self.assertAlmostEqual(
        ...
        self.assertAlmostEqual(
            results[0]["VMAF_integer_feature_adm3_score"], 0.9241841443734412, places=4
        )

        self.assertAlmostEqual(results[1]["VMAF_integer_feature_vif_score"], 1.0, places=4)
        self.assertAlmostEqual(
            results[1]["VMAF_integer_feature_motion_score"], 4.04982535417, places=2
        )
        self.assertAlmostEqual(
