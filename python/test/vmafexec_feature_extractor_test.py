...
class FeatureExtractorTest(MyTestCase):
    ...
    def test_run_integer_motion_fextractor(self):
        ...
        results = self.fextractor.results
        self.assertAlmostEqual(
            results[0]["integer_motion_feature_motion2_score"], 3.895345229166667, places=8
        )
        self.assertAlmostEqual(
            results[1]["integer_motion_feature_motion2_score"], 3.895345229166667, places=8
        )
        with self.assertRaises(KeyError):
    ...
    def test_run_integer_motion_fextractor_with_debug(self):
        ...
        self.assertAlmostEqual(
            results[0]["integer_motion_feature_motion_score"], 4.0498181041666665, places=8
        )
        self.assertAlmostEqual(
            results[1]["integer_motion_feature_motion_score"], 4.0498181041666665, places=8
        )
    ...
    def test_run_integer_motion_fextractor_12bit(self):
        ...
        results = self.fextractor.results
        self.assertAlmostEqual(
            results[0]["integer_motion_feature_motion2_score"], 2.8104533333333332, places=8
        )
        self.assertAlmostEqual(
            results[1]["integer_motion_feature_motion2_score"], 2.8104533333333332, places=8
        )
