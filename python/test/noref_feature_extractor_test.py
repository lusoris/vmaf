...
class NorefFeatureExtractorTest(unittest.TestCase):
    ...
    def test_run_noref_brisque_fextractor(self):
        ...
        self.assertAlmostEqual(
            results[0]["BRISQUE_noref_feature_alpha23_score"], 0.7640625000000005, places=4
        )
        self.assertAlmostEqual(
            results[0]["BRISQUE_noref_feature_alpha13_score"], 0.6322500000000002, places=4
        )
        self.assertAlmostEqual(
            results[0]["BRISQUE_noref_feature_N34_score"], -0.007239876204980851, places=4
        )

        self.assertAlmostEqual(
            results[1]["BRISQUE_noref_feature_alpha23_score"], 0.8644583333333339, places=4
        )
        self.assertAlmostEqual(
            results[1]["BRISQUE_noref_feature_alpha13_score"], 0.82906250000000103, places=4
        )
        self.assertAlmostEqual(
            results[1]["BRISQUE_noref_feature_N34_score"], -0.0092448158862212092, places=4
        )
    ...
    def test_run_noref_niqe_fextractor(self):
        ...
        self.assertAlmostEqual(
            results[0]["NIQE_noref_feature_alpha23_score"], 0.8168807870370377, places=4
        )
        self.assertAlmostEqual(
            results[0]["NIQE_noref_feature_alpha13_score"], 0.6949641203703707, places=4
        )
        self.assertAlmostEqual(
            results[0]["NIQE_noref_feature_alpha_m1_score"], 2.0924143518518536, places=3
        )
        self.assertAlmostEqual(
            results[0]["NIQE_noref_feature_blbr1_score"], 0.72958634325785898, places=3
        )

        self.assertAlmostEqual(
            results[1]["NIQE_noref_feature_alpha23_score"], 0.89566087962963026, places=4
        )
        self.assertAlmostEqual(
            results[1]["NIQE_noref_feature_alpha13_score"], 0.85539583333333391, places=4
        )
        self.assertAlmostEqual(
            results[1]["NIQE_noref_feature_alpha_m1_score"], 2.7192025462962985, places=4
        )
        self.assertAlmostEqual(
            results[1]["NIQE_noref_feature_blbr1_score"], 0.98723051960738684, places=4
        )
    ...
    def test_run_noref_niqe_fextractor_train(self):
        ...
        self.assertAlmostEqual(
            results[0]["NIQE_noref_feature_alpha23_score"], 0.97259000000000073, places=4
        )
        self.assertAlmostEqual(
            results[0]["NIQE_noref_feature_alpha13_score"], 0.80907000000000051, places=4
        )
        self.assertAlmostEqual(
            results[0]["NIQE_noref_feature_alpha_m1_score"], 2.6135250000000019, places=4
        )
        self.assertAlmostEqual(
            results[0]["NIQE_noref_feature_blbr1_score"], 0.9150526409258144, places=4
        )

        self.assertAlmostEqual(
            results[1]["NIQE_noref_feature_alpha23_score"], 0.97447727272727347, places=4
        )
        self.assertAlmostEqual(
            results[1]["NIQE_noref_feature_alpha13_score"], 0.89120909090909162, places=4
        )
        self.assertAlmostEqual(
            results[1]["NIQE_noref_feature_alpha_m1_score"], 3.0300909090909118, places=4
        )
        self.assertAlmostEqual(
            results[1]["NIQE_noref_feature_blbr1_score"], 1.0508255408831713, places=4
        )
    ...
    def test_run_noref_niqe_fextractor_with_patch_size(self):
        ...
        self.assertAlmostEqual(
            results[0]["NIQE_noref_feature_alpha23_score"], 0.8430156250000006, places=4
        )
        self.assertAlmostEqual(
            results[0]["NIQE_noref_feature_alpha13_score"], 0.71714583333333359, places=4
        )
        self.assertAlmostEqual(
            results[0]["NIQE_noref_feature_alpha_m1_score"], 2.2195590277777795, places=3
        )
        self.assertAlmostEqual(
            results[0]["NIQE_noref_feature_blbr1_score"], 0.74061215376929412, places=3
        )

        self.assertAlmostEqual(
            results[1]["NIQE_noref_feature_alpha23_score"], 0.9144918981481488, places=4
        )
        self.assertAlmostEqual(
            results[1]["NIQE_noref_feature_alpha13_score"], 0.87132291666666728, places=4
        )
        self.assertAlmostEqual(
            results[1]["NIQE_noref_feature_alpha_m1_score"], 2.8193532986111136, places=4
        )
        self.assertAlmostEqual(
            results[1]["NIQE_noref_feature_blbr1_score"], 0.99354006450609134, places=4
        )
