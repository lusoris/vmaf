...
For the concepts of `FeatureExtractor`, `QualityRunner` and `VmafQualityRunner`, please refer to the [Core Classes](docs/python.md#core-classes) section of the VMAF Python library documentation.
