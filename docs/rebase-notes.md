...
### 0026 — MS-SSIM separable decimate + AVX2/AVX-512/NEON SIMD

- **Workstream PRs**: `feat/ms-ssim-decimate-simd` (AVX2/AVX-512,
  commits `7de8cd7f` scalar separable, `5f93c864` AVX2, `73436438`
  AVX-512); `feat/ms-ssim-decimate-neon` (NEON follow-up).
- **Touches**:
