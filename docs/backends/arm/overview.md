...
[ADR-0445](../../adr/0445-moment-sve2-port.md). Adding more SVE2
...
| `float_moment` | yes         | yes         | 1st/2nd moment reduction; SVE2 path uses VLA f32→f64 widening — see [ADR-0445](../../adr/0445-moment-sve2-port.md) |
...
- `ms_ssim_decimate` — pinned by ADR-0125; per-lane `vfmaq_n_f32`
  ...
  `fmaf` chain exactly.
- `float_moment` (SVE2) — pinned by ADR-0445; tolerance-bounded
