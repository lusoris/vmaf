...
- `cambi_high_res_speedup` to speed up by downsampling post spatial mask
  for resolutions >= 1080p. However, some loss of accuracy is expected in
  metric. Possible min resolutions for the speed-up = [1080, 1440, 3840, 0].
