                            ...
                            int32_t *adm_div_lookup)
{
    ...
    for (int i = top; i < bottom; ++i) {
        for (int j = left; j < right_mod8; j += 8) {
            ...
            calc_angle(_mm256_extract_epi64(ot_dp_lo_epi64, 0),
                       _mm256_extract_epi64(o_mag_sq_lo_epi64, 0),
                       _mm256_extract_epi64(t_mag_sq_lo_epi64, 0), angle_flag[0]);
            calc_angle(_mm256_extract_epi64(ot_dp_lo_epi64, 1),
                       _mm256_extract_epi64(o_mag_sq_lo_epi64, 1),
                       _mm256_extract_epi64(t_mag_sq_lo_epi64, 1), angle_flag[1]);
            calc_angle(_mm256_extract_epi64(ot_dp_lo_epi64, 2),
                       _mm256_extract_epi64(o_mag_sq_lo_epi64, 2),
                       _mm256_extract_epi64(t_mag_sq_lo_epi64, 2), angle_flag[2]);
            calc_angle(_mm256_extract_epi64(ot_dp_lo_epi64, 3),
                       _mm256_extract_epi64(o_mag_sq_lo_epi64, 3),
                       _mm256_extract_epi64(t_mag_sq_lo_epi64, 3), angle_flag[3]);
            calc_angle(_mm256_extract_epi64(ot_dp_hi_epi64, 0),
                       _mm256_extract_epi64(o_mag_sq_hi_epi64, 0),
                       _mm256_extract_epi64(t_mag_sq_hi_epi64, 0), angle_flag[4]);
            calc_angle(_mm256_extract_epi64(ot_dp_hi_epi64, 1),
                       _mm256_extract_epi64(o_mag_sq_hi_epi64, 1),
                       _mm256_extract_epi64(t_mag_sq_hi_epi64, 1), angle_flag[5]);
            calc_angle(_mm256_extract_epi64(ot_dp_hi_epi64, 2),
                       _mm256_extract_epi64(o_mag_sq_hi_epi64, 2),
                       _mm256_extract_epi64(t_mag_sq_hi_epi64, 2), angle_flag[6]);
            calc_angle(_mm256_extract_epi64(ot_dp_hi_epi64, 3),
                       _mm256_extract_epi64(o_mag_sq_hi_epi64, 3),
                       _mm256_extract_epi64(t_mag_sq_hi_epi64, 3), angle_flag[7]);
                  ...
                  double adm_norm_view_dist, int adm_ref_display_height)
{
    ...
    __m256i accum_inner_h_lo_256, accum_inner_h_hi_256, accum_inner_v_lo_256, accum_inner_v_hi_256,
                             ...
                             double adm_norm_view_dist, int adm_ref_display_height)
{
    ...
    for (int i = top; i < bottom; ++i) {
        ...
        __m256i accum_inner_h_lo, accum_inner_h_hi, accum_inner_v_lo, accum_inner_v_hi,
