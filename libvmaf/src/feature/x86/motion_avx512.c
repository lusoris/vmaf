                            ...
                            ptrdiff_t src_stride, ptrdiff_t dst_stride, unsigned inp_size_bits)
{
    ...
    for (unsigned i = top_edge; i < bottom_edge; i++) {
        ...
        for (unsigned j = 0; j < width_mod_64; j += 64) {
            ...
            res0 =
                _mm512_permutex2var_epi64(res0, _mm512_set_epi64(11, 10, 3, 2, 9, 8, 1, 0), res8);
            res8 =
                _mm512_permutex2var_epi64(tmp, _mm512_set_epi64(15, 14, 7, 6, 13, 12, 5, 4), res8);
    ...
    *sad = 0;
    ...
    for (unsigned i = 0; i < height; i++) {
        ...
        *sad += inner_sad;
        ...
        final_accum = _mm512_add_epi64(
            final_accum,
            _mm512_cvtepi32_epi64(_mm256_add_epi32(_mm512_castsi512_si256(inter_accum_lo),
                                                   _mm512_extracti64x4_epi64(inter_accum_lo, 1))));
        final_accum = _mm512_add_epi64(
            final_accum,
            _mm512_cvtepi32_epi64(_mm256_add_epi32(_mm512_castsi512_si256(inter_accum_hi),
                                                   _mm512_extracti64x4_epi64(inter_accum_hi, 1))));
