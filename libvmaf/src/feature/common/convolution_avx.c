...
void convolution_f32_avx_s_1d_h_scanline_5(const float *RESTRICT filter, int filter_width,
                                           const float *RESTRICT src, float *RESTRICT dst,
                                           int j_end);
void convolution_f32_avx_s_1d_h_scanline_9(const float *RESTRICT filter, int filter_width,
                                           const float *RESTRICT src, float *RESTRICT dst,
                                           int j_end);
void convolution_f32_avx_s_1d_h_scanline_17(const float *RESTRICT filter, int filter_width,
                                            const float *RESTRICT src, float *RESTRICT dst,
                                            int j_end);
void convolution_f32_avx_s_1d_v_scanline_5(const float *RESTRICT filter, int filter_width,
                                           const float *RESTRICT src, float *RESTRICT dst,
                                           int src_stride, int j_end);
void convolution_f32_avx_s_1d_v_scanline_9(const float *RESTRICT filter, int filter_width,
                                           const float *RESTRICT src, float *RESTRICT dst,
                                           int src_stride, int j_end);
void convolution_f32_avx_s_1d_v_scanline_17(const float *RESTRICT filter, int filter_width,
                                            const float *RESTRICT src, float *RESTRICT dst,
                                            int src_stride, int j_end);

void convolution_f32_avx_s_1d_h_sq_scanline_5(const float *RESTRICT filter, int filter_width,
                                              const float *RESTRICT src, float *RESTRICT dst,
                                              int j_end);
void convolution_f32_avx_s_1d_h_sq_scanline_9(const float *RESTRICT filter, int filter_width,
                                              const float *RESTRICT src, float *RESTRICT dst,
                                              int j_end);
void convolution_f32_avx_s_1d_h_sq_scanline_17(const float *RESTRICT filter, int filter_width,
                                               const float *RESTRICT src, float *RESTRICT dst,
                                               int j_end);
void convolution_f32_avx_s_1d_v_sq_scanline_5(const float *RESTRICT filter, int filter_width,
                                              const float *RESTRICT src, float *RESTRICT dst,
                                              int src_stride, int j_end);
void convolution_f32_avx_s_1d_v_sq_scanline_9(const float *RESTRICT filter, int filter_width,
                                              const float *RESTRICT src, float *RESTRICT dst,
                                              int src_stride, int j_end);
void convolution_f32_avx_s_1d_v_sq_scanline_17(const float *RESTRICT filter, int filter_width,
                                               const float *RESTRICT src, float *RESTRICT dst,
                                               int src_stride, int j_end);

void convolution_f32_avx_s_1d_h_xy_scanline_5(const float *RESTRICT filter, int filter_width,
                                              const float *RESTRICT src1,
                                              const float *RESTRICT src2, float *RESTRICT dst,
                                              int j_end);
void convolution_f32_avx_s_1d_h_xy_scanline_9(const float *RESTRICT filter, int filter_width,
                                              const float *RESTRICT src1,
                                              const float *RESTRICT src2, float *RESTRICT dst,
                                              int j_end);
void convolution_f32_avx_s_1d_h_xy_scanline_17(const float *RESTRICT filter, int filter_width,
                                               const float *RESTRICT src1,
                                               const float *RESTRICT src2, float *RESTRICT dst,
                                               int j_end);
void convolution_f32_avx_s_1d_v_xy_scanline_5(const float *RESTRICT filter, int filter_width,
                                              const float *RESTRICT src1,
                                              const float *RESTRICT src2, float *RESTRICT dst,
                                              int src1_stride, int src2_stride, int j_end);
void convolution_f32_avx_s_1d_v_xy_scanline_9(const float *RESTRICT filter, int filter_width,
                                              const float *RESTRICT src1,
                                              const float *RESTRICT src2, float *RESTRICT dst,
                                              int src1_stride, int src2_stride, int j_end);
void convolution_f32_avx_s_1d_v_xy_scanline_17(const float *RESTRICT filter, int filter_width,
                                               const float *RESTRICT src1,
                                               const float *RESTRICT src2, float *RESTRICT dst,
                                               int src1_stride, int src2_stride, int j_end);

// Filter a single scanline.
static void convolution_f32_avx_s_1d_h_scanline(int N, const float *RESTRICT filter,
...
// Filter a single scanline.
static void convolution_f32_avx_s_1d_v_scanline(int N, const float *RESTRICT filter,
                                                int filter_width, const float *RESTRICT src,
                                                float *RESTRICT dst, int src_stride, int j_end)
{
...
void convolution_f32_avx_s_1d(int N, const float *RESTRICT filter, int filter_width,
                              ...
                              int width, int height, int src_stride, int dst_stride)
{
    ...
    for (int i = 0; i < radius; ++i) {
        for (int j = 0; j < width; ++j) {
            tmp[i * tmp_stride + j] = convolution_edge_s(false, filter, filter_width, src, width,
                                                         height, src_stride, i, j);
        }
    }
    for (int i = radius; i < i_vec_end; ++i) {
        convolution_f32_avx_s_1d_v_scanline(N, filter, filter_width, src + i * src_stride,
                                            tmp + i * tmp_stride, src_stride, width_mod8);
    ...
    for (int i = 0; i < height; ++i) {
        for (int j = 0; j < radius; ++j) {
            dst[i * dst_stride + j] = convolution_edge_s(true, filter, filter_width, tmp, width,
                                                         height, tmp_stride, i, j);
        }

        convolution_f32_avx_s_1d_h_scanline(N, filter, filter_width, tmp + i * tmp_stride,
                                            dst + i * dst_stride, j_vec_end);
                           ...
                           float *tmp, int width, int height, int src_stride, int dst_stride)
{
    switch (filter_width) {
    case 17:
        convolution_f32_avx_s_1d(17, filter, filter_width, src, dst, tmp, width, height, src_stride,
                                 dst_stride);
        break;
    case 9:
        convolution_f32_avx_s_1d(9, filter, filter_width, src, dst, tmp, width, height, src_stride,
                                 dst_stride);
        break;
    case 5:
        convolution_f32_avx_s_1d(5, filter, filter_width, src, dst, tmp, width, height, src_stride,
                                 dst_stride);
        break;
    case 3:
        convolution_f32_avx_s_1d(3, filter, filter_width, src, dst, tmp, width, height, src_stride,
                                 dst_stride);
        break;
    default:
        convolution_f32_avx_s_1d(0, filter, filter_width, src, dst, tmp, width, height, src_stride,
                                 dst_stride);
        break;
    }
}
...
// Filter a single scanline.
static void convolution_f32_avx_s_1d_v_sq_scanline(int N, const float *RESTRICT filter,
                                                   int filter_width, const float *RESTRICT src,
                                                   float *RESTRICT dst, int src_stride, int j_end)
{
    ...
    if (N == 5) {
        ...
        convolution_f32_avx_s_1d_v_sq_scanline_17(filter, filter_width, src, dst, src_stride,
                                                  j_end);
    } else {
...
void convolution_f32_avx_s_1d_sq(int N, const float *RESTRICT filter, int filter_width,
                                 const float *RESTRICT src, float *RESTRICT dst,
                                 ...
                                 int dst_stride)
{
    ...
    for (int i = 0; i < radius; ++i) {
        for (int j = 0; j < width; ++j) {
            tmp[i * tmp_stride + j] = convolution_edge_sq_s(false, filter, filter_width, src, width,
                                                            height, src_stride, i, j);
        }
    }
    for (int i = radius; i < i_vec_end; ++i) {
        convolution_f32_avx_s_1d_v_sq_scanline(N, filter, filter_width, src + i * src_stride,
                                               tmp + i * tmp_stride, src_stride, width_mod8);
                              ...
                              float *tmp, int width, int height, int src_stride, int dst_stride)
{
    switch (filter_width) {
    case 17:
        convolution_f32_avx_s_1d_sq(17, filter, filter_width, src, dst, tmp, width, height,
                                    src_stride, dst_stride);
        break;
    case 9:
        convolution_f32_avx_s_1d_sq(9, filter, filter_width, src, dst, tmp, width, height,
                                    src_stride, dst_stride);
        break;
    case 5:
        convolution_f32_avx_s_1d_sq(5, filter, filter_width, src, dst, tmp, width, height,
                                    src_stride, dst_stride);
        break;
    case 3:
        convolution_f32_avx_s_1d_sq(3, filter, filter_width, src, dst, tmp, width, height,
                                    src_stride, dst_stride);
        break;
    default:
        convolution_f32_avx_s_1d_sq(0, filter, filter_width, src, dst, tmp, width, height,
                                    src_stride, dst_stride);
        break;
    }
}
...
// Filter a single scanline.
static void convolution_f32_avx_s_1d_v_xy_scanline(int N, const float *RESTRICT filter,
                                                   ...
                                                   int src1_stride, int src2_stride, int j_end)
{
    ...
    if (N == 5) {
        convolution_f32_avx_s_1d_v_xy_scanline_5(filter, filter_width, src1, src2, dst, src1_stride,
                                                 src2_stride, j_end);
    } else if (N == 9) {
        convolution_f32_avx_s_1d_v_xy_scanline_9(filter, filter_width, src1, src2, dst, src1_stride,
                                                 src2_stride, j_end);
    } else if (N == 17) {
        convolution_f32_avx_s_1d_v_xy_scanline_17(filter, filter_width, src1, src2, dst,
                                                  src1_stride, src2_stride, j_end);
    } else {
...
void convolution_f32_avx_s_1d_xy(int N, const float *RESTRICT filter, int filter_width,
                                 ...
                                 int src1_stride, int src2_stride, int dst_stride)
{
    ...
    for (int i = radius; i < i_vec_end; ++i) {
        convolution_f32_avx_s_1d_v_xy_scanline(N, filter, filter_width, src1 + i * src1_stride,
                                               src2 + i * src2_stride, tmp + i * tmp_stride,
                                               src1_stride, src2_stride, width_mod8);
                              ...
                              int src1_stride, int src2_stride, int dst_stride)
{
    switch (filter_width) {
    case 17:
        convolution_f32_avx_s_1d_xy(17, filter, filter_width, src1, src2, dst, tmp, width, height,
                                    src1_stride, src2_stride, dst_stride);
        break;
    case 9:
        convolution_f32_avx_s_1d_xy(9, filter, filter_width, src1, src2, dst, tmp, width, height,
                                    src1_stride, src2_stride, dst_stride);
        break;
    case 5:
        convolution_f32_avx_s_1d_xy(5, filter, filter_width, src1, src2, dst, tmp, width, height,
                                    src1_stride, src2_stride, dst_stride);
        break;
    case 3:
        convolution_f32_avx_s_1d_xy(3, filter, filter_width, src1, src2, dst, tmp, width, height,
                                    src1_stride, src2_stride, dst_stride);
        break;
    default:
        convolution_f32_avx_s_1d_xy(0, filter, filter_width, src1, src2, dst, tmp, width, height,
                                    src1_stride, src2_stride, dst_stride);
        break;
    }
}
