 ...
 *  kernel-template consumer (T7-10b follow-up / ADR-0260).
 *
 *  Mirrors libvmaf/src/feature/cuda/integer_moment_cuda.h. The HIP
 *  kernel artefact (a `moment_score.hip` device blob equivalent of
 ...
 * header will declare its symbol the same way `moment_score_ptx` is
