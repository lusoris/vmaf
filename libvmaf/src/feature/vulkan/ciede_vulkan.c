...
static int create_pipeline(CiedeVulkanState *s)
{
    ...
    VkDescriptorSetLayoutBinding bindings[CIEDE_NUM_BINDINGS] = {0};
    ...
    VkDescriptorSetLayoutCreateInfo dslci = {
        ...
        .bindingCount = CIEDE_NUM_BINDINGS,
        .pBindings = bindings,
    };
    ...
    VkDescriptorPoolSize pool_size = {
        ...
        .descriptorCount = 4 * CIEDE_NUM_BINDINGS,
    };
