...
static void usage(const char *const app, const char *const reason, ...)
{
    ...
    (void)fprintf(
        ...
        "                                  coreml-gpu|coreml-cpu|openvino-npu|\n"
        "                                  openvino-cpu|openvino-gpu|rocm (default: auto)\n"
    ...
    while ((o = getopt_long(argc, argv, short_opts, long_opts, NULL)) >= 0) {
        ...
        case ARG_TINY_DEVICE:
            if (strcmp(optarg, "auto") && strcmp(optarg, "cpu") && strcmp(optarg, "cuda") &&
                ...
                strcmp(optarg, "coreml-cpu") && strcmp(optarg, "openvino-npu") &&
                ...
                error(argv[0], optarg, ARG_TINY_DEVICE,
                      ...
                      "coreml-cpu|openvino-npu|openvino-cpu|openvino-gpu|rocm");
            }
